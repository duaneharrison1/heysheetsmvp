      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pb-36">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose mt-6">
            <p>This is the Privacy Policy placeholder. Replace with your actual privacy policy content.</p>
            <p>We care about your privacy and explain how we collect and use data here.</p>
          </div>
        </div>
      </main>
